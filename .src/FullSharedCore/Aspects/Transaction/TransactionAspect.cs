...
{
    public class TransactionAspect : InterceptionBaseAttiribute
    {

        public IBaseUnitOfWork uow;
       // {
          //  get => __helper ?? (__helper= ServiceRegistiration_FullSharedCore.ServiceProvider.GetService<IBaseUnitOfWork>());
        //    get =>ServiceRegistiration_Core.ServiceProvider.GetService<IbaseUnitOfWork>();
        //}

        public TransactionAspect()
        {
            uow= ServiceRegistiration_FullSharedCore.ServiceProvider.GetService<IBaseUnitOfWork>();
        }
