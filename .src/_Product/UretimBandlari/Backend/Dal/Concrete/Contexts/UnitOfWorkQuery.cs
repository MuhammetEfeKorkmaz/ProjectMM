...
namespace Dal.Concrete.Contexts
{
    ...
    public class UnitOfWorkQuery : IUnitOfWorkQuery, IDisposable
    {
        public IMapper mapper { get; }
        private PDbContextQuery Context;

        public UnitOfWorkQuery(PDbContextQuery _context, IMapper _mapper)
        {
            Context = _context;
            mapper = _mapper;
